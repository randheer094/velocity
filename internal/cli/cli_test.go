	...
	cfg := &config.Config{
		Jira: config.JiraConfig{
			...
			TaskStatusMap: config.TaskStatusMap{
				...
				SubtaskInProgress: config.StatusBucket{Default: "In Progress"},
				Done:              config.StatusBucket{Default: "Done"},
				Dismissed:         config.StatusBucket{Default: "Dismissed"},
			},
			SubtaskStatusMap: config.SubtaskStatusMap{
				New:        config.StatusBucket{Default: "To Do"},
				InProgress: config.StatusBucket{Default: "In Progress"},
				PROpen:     config.StatusBucket{Default: "In Review"},
				CodeFailed: config.StatusBucket{Default: "Dev Failed"},
				Done:       config.StatusBucket{Default: "Done"},
				Dismissed:  config.StatusBucket{Default: "Dismissed"},
			},
		},
